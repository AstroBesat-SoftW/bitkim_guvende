...
import 'package:flutter/material.dart';
import 'package:firebase_database/firebase_database.dart';
class nemtamsorgu extends StatefulWidget {
  @override
  _nemtamsorguState createState() => _nemtamsorguState();
}

class _nemtamsorguState extends State<nemtamsorgu> {
  final DatabaseReference database =
  FirebaseDatabase.instance.reference().child("test/json/history3nem");
